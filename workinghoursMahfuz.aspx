<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="workinghoursMahfuz.aspx.vb" Inherits="workinghours" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddllocations" CssClass="form-control" data-placeholder="Choose location" ClientIDMode="Static" runat="server"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>--%>
                                                    ...
                                                    <asp:DropDownList ID="ddlStaff" CssClass="form-control" AutoPostBack="False" ClientIDMode="Static" runat="server"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" onclick="ClearData()" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="ClearData()" class="btn btn-secondary waves-effect" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('#btnsubmit').click(function () {
            ...
            if (shiftstart < shiftend) {
                ...
                alert("End Shift must be greater than Start Shift");
            }
        });
        ...
        function GetDataById(x) {
            ...
            $('#btndelete').click(function () {
                ...
                if (whid !== "") {
                    $.ajax({
                        url: 'workinghours.aspx/DeleteData',
                        type: 'POST',
                        cache: false,
                        contentType: "application/json; charset=utf-8",
                        data: JSON.stringify({ whid: whid }),
            ...
            function ClearData() {
                ...
                $("#<%= hdnWorkingHoursId.ClientID%>").val("");
            $("#<%= ddlStaff.ClientID%>").val("0");
            $("#<%= ddlshiftstart.ClientID%>").val("00:00");
            $("#<%= ddlshiftend.ClientID%>").val("00:00");
            $("#<%= hdnday.ClientID%>").val("");
            $("#<%= ddlrepeats.ClientID%>").val("Don't repeat");
        }
