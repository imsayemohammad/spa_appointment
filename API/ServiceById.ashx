<%@ WebHandler Language="VB" Class="ServiceById" %>
...
Public Class ServiceById : Implements IHttpHandler

    Dim context As HttpContext

    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Me.context = context
        Dim json = Me.GetServiceByMasterId()
    ...
    Private Function GetServiceByMasterId() As String
    ...
    Private Function GetServices(key As Integer, ByRef staffInfo As String) As String
        ...
        While reader.Read()
            ...
            '"": "service",
            '"": "princess",
            '"": "http://appointment.royex.net/Content/images/service-icons/home-images/img_one.jpg",
            '"width": 240,
            '"height": 495,
            '"aspectRatio": 0,
            '"inactiveIcon": "http://appointment.royex.net/Content/images/service-icons/icons/PRINCESS.png",
            '"activeIcon": "http://appointment.royex.net/Content/images/service-icons/icons/active/PRINCESS.png",
            '"serviceRate": 200,
            ...
            if currentItemNumber = 1 then
                ...
                staffInfo += "{ ""staffId"":""" + reader("StaffId").ToString() + """,""staffName"":""" + StaffName + """,""Image"":""" + StaffImage + """, ""serviceId"" : " + reader("ServiceRequestDetailId").ToString() + ",""price"":"+reader("ServiceRate").ToString()+"}"
                currentItemNumber += 1
            else
                services += " ,{ ""serviceId"" : " + reader("ServiceRequestDetailId").ToString() + ",""title"" : """ + Name + """,""serviceType"" : """ + serviceType + """,""serviceType"" : """ + serviceType + """}"
                staffInfo += ",{ ""staffId"":""" + reader("StaffId").ToString() + """,""staffName"":""" + StaffName + """,""Image"":""" + StaffImage + """, ""serviceId"" : " + reader("ServiceRequestDetailId").ToString() + ",""price"":"+reader("ServiceRate").ToString()+"}"
