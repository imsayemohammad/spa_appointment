<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ClientInfo.aspx.vb" Inherits="ClientInfo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="Server">
                            ...
                            <div class="col-lg-4 col-xlg-3 col-md-5">
                                <div class="card">
                                    ...
                                    <div class="card-body bg-light-inverse">
                                        ...
                                        <a id="btnadd" class="btn btn-danger waves-effect btn-block waves-light addnewFancy" href="Client_popup.aspx?page=clientinfo&id=<%= Request.QueryString("id")%>" data-fancybox data-type="iframe" style="color: #fff">Edit</a>
                                    </div>
                                            ...
                                            <div class="card">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <asp:ListView ID="ListView2" runat="server" DataKeyNames="ClientID" DataSourceID="SqlDataSource1">
                                                                <EmptyDataTemplate>
                                            ...
                                            <div class="card">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="ClientID" DataSourceID="sdsClientappoints">
                                                                <EmptyDataTemplate>
                                                                    <table id="Table1" runat="server" style="">
                                                                        <tr>
                                                                            <td>No data was found.</td>
    ...
    <asp:SqlDataSource ID="sdsClientappoints" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        SelectCommand="SELECT *, CONVERT(VARCHAR(10), srd.StartDate, 101) AS StartDT, CONVERT(VARCHAR(8), srd.StartDateTime, 8) AS StartTime, CONVERT(VARCHAR(8), srd.EndDateTime, 8) AS EndTime FROM ServiceRequestDetails srd Inner Join ServiceRequestMasters srm ON srd.ServiceRequestMasterId = srm.ServiceRequestMasterId Where ClientId=@ClientId">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        SelectCommand="SELECT *, CONVERT(VARCHAR(10), srd.StartDate, 101) AS StartDT, CONVERT(VARCHAR(8), srd.StartDateTime, 8) AS StartTime, CONVERT(VARCHAR(8), srd.EndDateTime, 8) AS EndTime FROM ServiceRequestDetails srd Inner Join ServiceRequestMasters srm ON srd.ServiceRequestMasterId = srm.ServiceRequestMasterId Where ClientId=@ClientId And GETDATE() < srd.StartDate">
        <SelectParameters>
            <asp:QueryStringParameter Name="ClientId" QueryStringField="id" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
